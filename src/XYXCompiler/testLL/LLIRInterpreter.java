...
public class LLIRInterpreter {
    private String path = "C:\\Users\\lenovo\\Desktop\\MX-Compiler\\XYXCompiler\\src\\XYXCompiler\\testLL\\";
    ...
    public LLIRInterpreter(String name, boolean isSSAMode) throws IOException {
    ...
    public void run() {
        try {
            ...
            exitcode = retValue;
            exception = false;
            System.err.println("exitcode:  " + getExitcode());
            System.err.println("exception: " + exitException());
    ...
    public static void main(String[] args) throws IOException {
        ...
        LLIRInterpreter vm = new LLIRInterpreter("",ssa);
        if (ssa)
